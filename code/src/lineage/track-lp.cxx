...
try
{
    ...
    // solve problem:
    auto solution = lineage::solver_lp<andres::lp::Gurobi>(problem, parameters.terminationCost, parameters.birthCost, parameters.bifurcationConstraint, parameters.solutionName);
